...
import { Terminal, Sun, Moon, UserCheck } from 'lucide-react';
...
export function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-40 px-6 lg:px-16 py-5 transition-all duration-500">
        <div
        ...
        >
          ...
          {/* Status Pill, Theme Switcher, Login & Register CTAs */}
          <div className="flex items-center gap-2 sm:gap-3">
            <div
              className={`hidden lg:flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-mono border transition-colors ${
                isDark
